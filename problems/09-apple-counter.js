...
appleCounter(obj3); // => 3
***********************************************************************/
// take in object, iterate thru to find apples - could get array of keys, then search those.
// or could do for/in loop and for each one check to see if contains apple, then add to sum
